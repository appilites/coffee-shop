  ...
  return (
    ...
    >
      <span className="flex items-center gap-1 sm:gap-1.5 leading-none">
        ...
        <span className="font-semibold tabular-nums text-[10px] sm:text-xs md:text-sm">{pts}</span>
        <span className="sm:hidden text-[9px] text-muted-foreground font-normal">pts</span>
